...
(
  ...
  inner join `lcp-consortium.eicu_crd_ii_v0_1_0.lab` as lab
...
(
  ...
  from `lcp-consortium.eicu_crd_ii_v0_1_0.patient` as pt
  inner join `lcp-consortium.eicu_crd_ii_v0_1_0.vitalperiodic` as vp
...
(
  ...
  from `lcp-consortium.eicu_crd_ii_v0_1_0.patient` as pt
  inner join `lcp-consortium.eicu_crd_ii_v0_1_0.medication` as med
...
left join (select patientunitstayid, max(apachescore) as apachescore, min(cast(predictedhospitalmortality as numeric)) as predictedhospitalmortality from `lcp-consortium.eicu_crd_ii_v0_1_0.apachepatientresults` where apacheversion = 'IVa' group by patientunitstayid) aiva
