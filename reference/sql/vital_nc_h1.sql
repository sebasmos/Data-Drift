...
DROP TABLE IF EXISTS gossis_vital_nc_h1;
CREATE TABLE gossis_vital_nc_h1 as
...
select
  ...
  , case
    ...
    as map
  from `lcp-consortium.eicu_crd_ii_v0_1_0.nursecharting`
...
(
  ...
  , min(case when RespiratoryRate >= 0 and RespiratoryRate <= 300 then RespiratoryRate else null end) as RespiratoryRate_min
  , min(case when o2saturation >= 0 and o2saturation <= 100 then o2saturation else null end) as o2saturation_min
  , min(case when nibp_systolic >= 1 and nibp_systolic <= 300 then nibp_systolic else null end) as nibp_systolic_min
  , min(case when nibp_diastolic >= 1 and nibp_diastolic <= 200 then nibp_diastolic else null end) as nibp_diastolic_min
  , min(case when nibp_mean >= 1 and nibp_mean <= 334 then nibp_mean else null end) as nibp_mean_min
  , min(case when temperature >= 25 and temperature <= 46 then temperature else null end) as temperature_min
  , min(case when ibp_systolic >= 1 and ibp_systolic <= 300 then ibp_systolic else null end) as ibp_systolic_min
  , min(case when ibp_diastolic >= 1 and ibp_diastolic <= 200 then ibp_diastolic else null end) as ibp_diastolic_min
  , min(case when ibp_mean >= 1 and ibp_mean <= 334 then ibp_mean else null end) as ibp_mean_min
  , min(case when gcs > 2 and gcs < 16 then gcs else null end) as gcs_min
  , min(case when map >= 1 and map <= 334 then map else null end) as map_min
  -- highest
  , max(case when heartrate >= 0 and heartrate <= 400 then heartrate else null end) as heartrate_max
  , max(case when RespiratoryRate >= 0 and RespiratoryRate <= 300 then RespiratoryRate else null end) as RespiratoryRate_max
  , max(case when o2saturation >= 0 and o2saturation <= 100 then o2saturation else null end) as o2saturation_max
  , max(case when nibp_systolic >= 1 and nibp_systolic <= 300 then nibp_systolic else null end) as nibp_systolic_max
  , max(case when nibp_diastolic >= 1 and nibp_diastolic <= 200 then nibp_diastolic else null end) as nibp_diastolic_max
  , max(case when nibp_mean >= 1 and nibp_mean <= 334 then nibp_mean else null end) as nibp_mean_max
  , max(case when temperature >= 25 and temperature <= 45 then temperature else null end) as temperature_max
  , max(case when ibp_systolic >= 1 and ibp_systolic <= 300 then ibp_systolic else null end) as ibp_systolic_max
  , max(case when ibp_diastolic >= 1 and ibp_diastolic <= 200 then ibp_diastolic else null end) as ibp_diastolic_max
  , max(case when ibp_mean >= 1 and ibp_mean < 334 then ibp_mean else null end) as ibp_mean_max
  , max(case when gcs > 2 and gcs < 16 then gcs else null end) as gcs_max
  , max(case when map >= 1 and map <= 334 then map else null end) as map_max
  from nc
