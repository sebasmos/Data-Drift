...
- MIMIC-III, MIMIC-IV, Saltz, Zhejiang, eICU, eICU-New
- Scores: SOFA, OASIS, SAPS-II, APS-III (all datasets)
...
def fig2_age_stratified_drift(results, deltas):
    ...
    dataset_order = ['mimiciii', 'mimiciv', 'saltz', 'zhejiang', 'eicu', 'eicu_new']
...
def fig7_money_figure(results, deltas):
    ...
    for dataset in ['mimiciv', 'saltz', 'zhejiang']:
        df_sub = age_data[age_data['dataset'] == dataset]
        if df_sub.empty:
            continue
...
def copy_supplementary_figures():
    ...
    supplementary_figures = {
        ...
        OUTPUT_DIR / 'saltz' / 'saltz_drift_analysis.png': FIGURES_DIR / 'figS3_saltz.png',
    }
